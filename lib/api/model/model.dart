...
class RealmAvailableVideoChatProviders {
  ...
  RealmAvailableVideoChatProviders({required this.name, required this.id});

  factory RealmAvailableVideoChatProviders.fromJson(
    Map<String, dynamic> json,
  ) => _$RealmAvailableVideoChatProvidersFromJson(json);

  Map<String, dynamic> toJson() =>
      _$RealmAvailableVideoChatProvidersToJson(this);
}
...
enum RealmVideoChatProvider {
  ...
  const RealmVideoChatProvider({required this.apiValue});
...
class User {
  ...
  bool
  isActive; // Really sometimes absent in /register, but we normalize that away; see [InitialSnapshot.realmUsers].
  ...
  String timezone;
  String?
  avatarUrl; // TODO(#255) distinguish null from missing, as a `JsonNullable<String>?`
  int avatarVersion;
