...
class DesignVariables extends ThemeExtension<DesignVariables> {
  static final light = DesignVariables._(
    ...
    contextMenuItemBg: const Color(0xff149593),
    contextMenuItemBgDanger: const Color(0xffc0070a), // TODO(#831) red/550
    contextMenuItemIcon: const Color(0xff149593),
    ...
    contextMenuItemText: const Color(0xff149593),
    ...
    fabBg: const Color(0xff149593),
    fabBgPressed: const Color(0xff149593),
